export function threeDaysBefore(name, amount, date) {
...
export function dueToday(name, amount) {
...
export function overdue(name, amount, days) {
...
export function paymentReceived(name, amount, remaining) {
